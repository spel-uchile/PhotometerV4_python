/* ==================================================================================
  ...
  // =====|=============|========|=====================================================
  // 1.00 | 25 Jul 2019 | CGC   | Second release
  // ==================================================================================*/
...
void setup()
{
  String zz, zz2_1, zz2_2, zz2_3, zz3, zz4;

  // Inicialización ADC
  // Seleción de pines puerto SPI
  pinMode(SELPIN, OUTPUT);
  pinMode(DATAOUT, OUTPUT);
  pinMode(DATAIN, INPUT);
  pinMode(SPICLOCK, OUTPUT);

  // De deactivan antes de comenzar
  ...
  // Esperamos y tomamos datos de GPS
  
  delay(100);
  //Serial.println("Tomado datos GPS");
  zz3 = GPS();
  delay(100);

  // Encendemos el GPRS y el lector de SD
  //Serial.println("Encendiendo GPRS y SD");
  GPRSBee.begin(9600);
  SD.begin(6);
  delay(100);

  // Tomamos datos del BMP180
  //Serial.println("Tomando datos BMP180");
  zz4 = BMP();
  delay(100);
  ...
  if (dataFile) {
    ...
    //Serial.println(zz + zz2_1 + zz3 + zz4);
    //Serial.println(zz + zz2_2 + zz3 + zz4);
    //Serial.println(zz + zz2_3 + zz3 + zz4);
  }
  ...
  // Fin de medicion, esperando apagado
  //Serial.println("Fin medicion");
}
...
String GPS()
{
  ...
  while ((millis() < tiempo + 30000) && (ss.available()))
  {
