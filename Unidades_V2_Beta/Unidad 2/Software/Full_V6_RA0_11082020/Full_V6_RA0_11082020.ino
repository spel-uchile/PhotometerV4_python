...
char ID[] = "002"; // ID del instrumento
...
void setup()
{
  String zz, zz2_1, zz2_2, zz2_3, zz3, zz3_1, zz3_2, zz3_3, zz4, file_name;
  ...
  file_name.concat(gps.date.day());
  file_name.concat(gps.date.month());
  file_name.concat(gps.date.year());
