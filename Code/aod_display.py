...
def stgo_useful_data(stgo_data, sensor):
    ...
    for data in stgo_data:
        try:
            ...
            pass
    return m, date, seconds, pressure, air_mass, r, altitude, temperature, np.mean(latitude), np.mean(longitude)
    ...
    for stgo_unit in stgo_units:
        with open('Code/../../Calibration/'+ stgo_unit +'.json', 'r') as file:
            ...
            if stgo_unit == '010':
                ...
                x1 = np.array(json_file['x1_v3'])
                d1 = np.array(json_file['date1'])
                x2 = np.array(json_file['x2_v3'])
                d2 = np.array(json_file['date2'])
                x3 = np.array(json_file['x3_v3'])
                d3 = np.array(json_file['date3'])
                x4 = np.array(json_file['x4_v3'])    
                d4 = np.array(json_file['date4'])
            ...
            with open('Code/../../Out/CV/'+ stgo_unit +'.csv', 'w', newline = '') as csvfile:
                ...
                if chk1 != 0:
                    ...
                    x1_csv = np.array([d1[x1f], x10[x1f],x11[x1f]])
                    x1_csv = x1_csv.tolist()
                    
                    for i in range(len(x1_csv[0])):
                        csvwriter.writerow([x1_csv[0][i][0:10],x1_csv[1][i],x1_csv[2][i]])               
                ...
                if chk2 != 0:
                    ...
                    x2_csv = np.array([d2[x2f], x20[x2f],x21[x2f]])
                    x2_csv = x2_csv.tolist()
                    
                    for i in range(len(x2_csv[0])):
                        csvwriter.writerow([x2_csv[0][i][0:10],x2_csv[1][i],x2_csv[2][i]])
                ...
                if chk3 != 0:
                    ...
                    x3_csv = np.array([d3[x3f], x30[x3f],x31[x3f]])
                    x3_csv = x3_csv.tolist()
                    
                    for i in range(len(x3_csv[0])):
                        csvwriter.writerow([x3_csv[0][i][0:10],x3_csv[1][i],x3_csv[2][i]])
                ...
                if chk4 != 0:
                    ...
                    x4_csv = np.array([d4[x4f], x40[x4f],x41[x4f]])
                    x4_csv = x4_csv.tolist()
                    
                    for i in range(len(x4_csv[0])):
                        csvwriter.writerow([x4_csv[0][i][0:10],x4_csv[1][i],x4_csv[2][i]])
        ...
        while datei != dt.datetime(2021, 1, 1):
            ...
            if (stgo_data != []):
                ...
                m1, date1, seconds1, pressure1, airmass1, r1, altitude1, temperature1, latitude1, longitude1 = stgo_useful_data(stgo_data, 'm1')
                m2, date2, seconds2, pressure2, airmass2, r2, altitude2, temperature2, latitude2, longitude2 = stgo_useful_data(stgo_data, 'm2')
                m3, date3, seconds3, pressure3, airmass3, r3, altitude3, temperature3, latitude3, longitude3 = stgo_useful_data(stgo_data, 'm3')
                m4, date4, seconds4, pressure4, airmass4, r4, altitude4, temperature4, latitude4, longitude4 = stgo_useful_data(stgo_data, 'm4')
                ...
                if (aero_data != []):
                    ...
                    if m1 != []:
                        ...
                        am11, am12, am13, apressure1, aaltitude1, aairmass1, ar1, adel1 = interpolate(m1, pressure1, altitude1, airmass1, r1, seconds1, seconds1)
                    ...
                    if m2 != []:
                        ...
                        am21, am22, am23, apressure2, aaltitude2, aairmass2, ar2, adel2 = interpolate(m2, pressure2, altitude2, airmass2, r2, seconds2, seconds2)
                    ...
                    if m3 != []:
                        ...
                        am31, am32, am33, apressure3, aaltitude3, aairmass3, ar3, adel3 = interpolate(m3, pressure3, altitude3, airmass3, r3, seconds3, seconds3)
                    ...
                    if m4 != []:
                        ...
                        am41, am42, am43, apressure4, ialtitude4, aairmass4, ar4, adel4 = interpolate(m4, pressure4, altitude4, airmass4, r4, seconds4, seconds4) 
...
# Caso de intrumento con datos de calibracion
                        ...
                        if stgo_unit == '010':
                            if m1 != [] and chk1:
                                ...
                                aod_111 = stgo_aod(v11, ir1, m11, ipressure1, iairmass1, np.delete(ozone,del1))
                                aod_121 = stgo_aod(v11, ir1, m12, ipressure1, iairmass1, np.delete(ozone,del1))
                                aod_131 = stgo_aod(v11, ir1, m13, ipressure1, iairmass1, np.delete(ozone,del1))
                    
                                aod_a111 = stgo_aod(v11, ar1, am11, apressure1, aairmass1, aozone1)
                                aod_a121 = stgo_aod(v11, ar1, am12, apressure1, aairmass1, aozone1)
                                aod_a131 = stgo_aod(v11, ar1, am13, apressure1, aairmass1, aozone1)
                    
                                aod_112 = stgo_aod(v12, ir1, m11, ipressure1, iairmass1, np.delete(ozone,del1))
                                aod_122 = stgo_aod(v12, ir1, m12, ipressure1, iairmass1, np.delete(ozone,del1))
                                aod_132 = stgo_aod(v12, ir1, m13, ipressure1, iairmass1, np.delete(ozone,del1))
                            ...
                            if m2 != [] and chk2:
                                ...
                                aod_211 = stgo_aod(v21, ir2, m21, ipressure2, iairmass2, np.delete(ozone,del2))
                                aod_221 = stgo_aod(v21, ir2, m22, ipressure2, iairmass2, np.delete(ozone,del2))
                                aod_231 = stgo_aod(v21, ir2, m23, ipressure2, iairmass2, np.delete(ozone,del2))
                    
                                aod_a211 = stgo_aod(v21, ar2, am21, apressure2, aairmass2, aozone2)
                                aod_a221 = stgo_aod(v21, ar2, am22, apressure2, aairmass2, aozone2)
                                aod_a231 = stgo_aod(v21, ar2, am23, apressure2, aairmass2, aozone2)
                    
                                aod_212 = stgo_aod(v22, ir2, m21, ipressure2, iairmass2, np.delete(ozone,del2))
                                aod_222 = stgo_aod(v22, ir2, m22, ipressure2, iairmass2, np.delete(ozone,del2))
                                aod_232 = stgo_aod(v22, ir2, m23, ipressure2, iairmass2, np.delete(ozone,del2))
                            ...
                            if m3 != [] and chk3:
                                ...
                                aod_311 = stgo_aod(v31, ir3, m31, ipressure3, iairmass3, np.delete(ozone,del3))
                                aod_321 = stgo_aod(v31, ir3, m32, ipressure3, iairmass3, np.delete(ozone,del3))
                                aod_331 = stgo_aod(v31, ir3, m33, ipressure3, iairmass3, np.delete(ozone,del3))

                                aod_a311 = stgo_aod(v31, ar3, am31, apressure3, aairmass3, aozone3)
                                aod_a321 = stgo_aod(v31, ar3, am32, apressure3, aairmass3, aozone3)
                                aod_a331 = stgo_aod(v31, ar3, am33, apressure3, aairmass3, aozone3) 
                    
                                aod_312 = stgo_aod(v32, ir3, m31, ipressure3, iairmass3, np.delete(ozone,del3))
                                aod_322 = stgo_aod(v32, ir3, m32, ipressure3, iairmass3, np.delete(ozone,del3))
                                aod_332 = stgo_aod(v32, ir3, m33, ipressure3, iairmass3, np.delete(ozone,del3))
                            ...
                            if m4 != [] and chk4:
                                ...
                                aod_411 = stgo_aod(v41, ir4, m41, ipressure4, iairmass4, np.delete(ozone,del4))
                                aod_421 = stgo_aod(v41, ir4, m42, ipressure4, iairmass4, np.delete(ozone,del4))
                                aod_431 = stgo_aod(v41, ir4, m43, ipressure4, iairmass4, np.delete(ozone,del4))

                                aod_a411 = stgo_aod(v41, ar4, am41, apressure4, aairmass4, aozone4)
                                aod_a421 = stgo_aod(v41, ar4, am42, apressure4, aairmass4, aozone4)
                                aod_a431 = stgo_aod(v41, ar4, am43, apressure4, aairmass4, aozone4) 
                    
                                aod_412 = stgo_aod(v42, ir4, m41, ipressure4, iairmass4, np.delete(ozone,del4))
                                aod_422 = stgo_aod(v42, ir4, m42, ipressure4, iairmass4, np.delete(ozone,del4))
                                aod_432 = stgo_aod(v42, ir4, m43, ipressure4, iairmass4, np.delete(ozone,del4))
                            ...
                            if m1 != [] and chk1:
                                ...
                                response11 = rmse_calibrationv3(v11)
                                response12 = rmse_calibrationv3(v12)

                                aod_111 = stgo_aodv3(v11, ir1, m11, ipressure1, iairmass1)
                                
                                aod_a111 = stgo_aodv3(v11, ar1, am11, apressure1, aairmass1)

                                aod_112 = stgo_aodv3(v12, ir1, m11, ipressure1, iairmass1)
                                ...
                                plot_day(stgo_unit, time_1, aod_111, aero_time= aero_date, aero_data = aero_aod11, sensor = 'Sensor 1 C')
                                plot_day(stgo_unit, date1, aod_a111, aero_time= aero_date, aero_data = aero_aod11, sensor = 'Sensor 1 C NI')     
                            ...
                            if m2 != [] and chk2:
                                ...
                                response21 = rmse_calibrationv3(v21)
                                response22 = rmse_calibrationv3(v22)

                                aod_211 = stgo_aodv3(v21, ir2, m21, ipressure2, iairmass2)

                                aod_a211 = stgo_aodv3(v21, ar2, am21, apressure2, aairmass2)

                                aod_212 = stgo_aodv3(v22, ir2, m21, ipressure2, iairmass2)
                                ...
                                plot_day(stgo_unit, time_2, aod_211, aero_time= aero_date, aero_data = aero_aod21, sensor = 'Sensor 2 C')
                                plot_day(stgo_unit, date2, aod_a211, aero_time= aero_date, aero_data = aero_aod21, sensor = 'Sensor 2 C NI')     
                            ...
                            if m3 != [] and chk3:
                                ...
                                response31 = rmse_calibrationv3(v31)
                                response32 = rmse_calibrationv3(v32)

                                aod_311 = stgo_aodv3(v31, ir3, m31, ipressure3, iairmass3)
                                
                                aod_a311 = stgo_aodv3(v31, ar3, am31, apressure3, aairmass3)

                                aod_312 = stgo_aodv3(v32, ir3, m31, ipressure3, iairmass3)
                                ...
                                plot_day(stgo_unit, time_3, aod_311, aero_time= aero_date, aero_data = aero_aod31, sensor = 'Sensor 3 C')
                                plot_day(stgo_unit, date3, aod_a311, aero_time= aero_date, aero_data = aero_aod31, sensor = 'Sensor 3 C NI')     
                            ...
                            if m4 != [] and chk4:
                                ...
                                response41 = rmse_calibrationv3(v41)
                                response42 = rmse_calibrationv3(v42)
                                
                                aod_411 = stgo_aodv3(v41, ir4, m41, ipressure4, iairmass4)
                  
                                aod_a411 = stgo_aodv3(v41, ar4, am41, apressure4, aairmass4)  
                  
                                aod_412 = stgo_aodv3(v42, ir4, m41, ipressure4, iairmass4)
                                ...
                                plot_day(stgo_unit, time_4, aod_411, aero_time= aero_date, aero_data = aero_aod41, sensor = 'Sensor 4 C')
                                plot_day(stgo_unit, date4, aod_a411, aero_time= aero_date, aero_data = aero_aod41, sensor = 'Sensor 4 C NI')     
...
# Caso instrumento en terreno
                        ...
                        if stgo_unit == '010':
                            ...
                            if m1 != [] and chk1:
                                ...
                                plot_day(stgo_unit, time_1, aod_111, aero_time= aero_date, aero_data = aero_aod11, sensor = 'Sensor 1 O')
                                plot_day(stgo_unit, date1, aod_a111, aero_time= aero_date, aero_data = aero_aod11, sensor = 'Sensor 1 O NI')     
                            ...
                            if m2 != [] and chk2:
                                ...
                                plot_day(stgo_unit, time_2, aod_211, aero_time= aero_date, aero_data = aero_aod21, sensor = 'Sensor 2 O')
                                plot_day(stgo_unit, date2, aod_a211, aero_time= aero_date, aero_data = aero_aod21, sensor = 'Sensor 2 O NI')     
                            ...
                            if m3 != [] and chk3:
                                ...
                                plot_day(stgo_unit, time_3, aod_311, aero_time= aero_date, aero_data = aero_aod31, sensor = 'Sensor 3 O')
                                plot_day(stgo_unit, date3, aod_a311, aero_time= aero_date, aero_data = aero_aod31, sensor = 'Sensor 3 O NI')     
                            ...
                            if m4 != [] and chk4:
                                ...
                                plot_day(stgo_unit, time_4, aod_411, aero_time= aero_date, aero_data = aero_aod41, sensor = 'Sensor 4 O')
                                plot_day(stgo_unit, date4, aod_a411, aero_time= aero_date, aero_data = aero_aod41, sensor = 'Sensor 4 O NI')     
...
# Caso Con datos de terreno, pero no de aeronet
                    ...
                    if m1 != []:
                        m11, m12, m13, ipressure1, ialtitude1, iairmass1, ir1, del1 = interpolate(m1, pressure1, altitude1, airmass1, r1, seconds1, seconds1)
                    if m2 != []:
                        m21, m22, m23, ipressure2, ialtitude2, iairmass2, ir2, del2 = interpolate(m2, pressure2, altitude2, airmass2, r2, seconds2, seconds2)
                    if m3 != []:
                        m31, m32, m33, ipressure3, ialtitude3, iairmass3, ir3, del3 = interpolate(m3, pressure3, altitude3, airmass3, r3, seconds3, seconds3)
                    if m4 != []:
                        m41, m42, m43, ipressure4, ialtitude4, iairmass4, ir4, del4 = interpolate(m4, pressure4, altitude4, airmass4, r4, seconds4, seconds4) 
                    ...
                    if stgo_unit == '010':
                        ...
                        if m2 != [] and chk2:
                            ...
                            aod_211 = stgo_aod(v21, ir2, m21, ipressure2, iairmass1, np.delete(ozone,del2))
                            aod_221 = stgo_aod(v21, ir2, m22, ipressure2, iairmass1, np.delete(ozone,del2))
                            aod_231 = stgo_aod(v21, ir2, m23, ipressure2, iairmass1, np.delete(ozone,del2))
                        ...
                        if m1 != [] and chk1:
                            ...
                            plot_day(stgo_unit, time_1, aod_111, sensor = 'Sensor 1 NA')     
                        ...
                        if m2 != [] and chk2:
                            ...
                            plot_day(stgo_unit, time_2, aod_211, sensor = 'Sensor 2 NA')     
                        ...
                        if m3 != [] and chk3:
                            ...
                            plot_day(stgo_unit, time_3, aod_311, sensor = 'Sensor 3 NA')     
                        ...
                        if m4 != [] and chk4:
                            ...
                            plot_day(stgo_unit, time_4, aod_411, sensor = 'Sensor 4 NA')     
...
# Error No caracterizado
        ...
        with open('Code/../../Out/RMSE/'+ stgo_unit +'_RMSE.csv', 'w', newline = '') as csvfile:
            ...
            if chk4 != 0:
                csvwriter.writerow(['RMSE41 Sensor 4'])
                
                for i in range(len(rmse41)):
                    csvwriter.writerow(rmse41[i])               
                
                csvwriter.writerow(['RMSE42 Sensor 4'])
